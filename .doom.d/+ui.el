...
(custom-set-faces!
  ...
  `(+org-todo-onhold :family ,felix/punk-font :weight semi-bold :height ,felix/punk-height)
  `(+org-todo-project :family ,felix/punk-font :weight semi-bold :height ,felix/punk-height)
  `(+org-todo-active :family ,felix/punk-font :weight semi-bold :height ,felix/punk-height)
